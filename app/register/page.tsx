              ...
              >
                ...
                <label className="flex items-center gap-2 text-sm text-neutral-300">
                  <input
                    ...
                    onChange={handleChange}
                    className="h-4 w-4 rounded border-white/20 bg-white/3 accent-red-500"
                  />
                  <span>
                    I agree to the{" "}
                ...
                <button
                  type="submit"
                  className="mt-1 w-full cursor-pointer rounded-lg bg-red-600 py-2.5 font-semibold transition-colors hover:bg-red-700"
                >
                  Create Account
                </button>
              </form>
